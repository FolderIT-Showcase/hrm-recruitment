            ...
            editInterview: function ( invID ) {
                jQuery.erpPopup( {
                    ...
                    onReady: function ( modal ) {
                        ...
                        jQuery( '#internal_type_of_interview option' ).each( function () {
                            if ( jQuery( this ).text() == interviewInternalTypeTitle ) {
                                this.selected = (this.text == interviewInternalTypeTitle);
                            }
                        } );
                        jQuery( '#internal_type_of_interview' ).change( function () {
                            var selected_interview_internal_name = jQuery( this ).find( "option:selected" ).text();
                            jQuery( '#internal_type_of_interview_text' ).val( selected_interview_internal_name );
                        } );
