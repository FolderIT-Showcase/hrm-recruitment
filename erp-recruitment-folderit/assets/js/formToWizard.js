...
(function ($) {
    $.fn.formToWizard = function (options) {
        ...
        function createPrevButton(i) {
            ...
            $("#" + stepName + "commands").append("<input type='button' id='" + stepName + "Prev' class='prev' value='Volver'>");
        ...
        function createNextButton(i) {
            ...
            $("#" + stepName + "commands").append("<input type='button' id='" + stepName + "Next' class='next' value='Siguiente'>");
