 ...
 * Employee welcome
 */
class Opening_Report extends Email {

    use Hooker;

    function __construct() {
        $this->id          = 'opening-report';
        $this->title       = __( 'Opening Report', 'wp-erp-rec' );
        $this->description = __( 'Opening Repost.', 'wp-erp-rec' );

        $this->subject     = __( 'Opening Report', 'wp-erp-rec');
        $this->heading     = __( 'Opening Report', 'wp-erp-rec');
