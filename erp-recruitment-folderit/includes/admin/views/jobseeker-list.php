              ...
              <div class="inside" style="margin-bottom:0;margin-top:0;overflow-y:hidden;padding-bottom:0;padding-left:0;">
                ...
                <div class="single-information-container">
                  <div id="candidate-overview-zone">
                    ...
                    <?php if ( $jobid == 0 ) : ?>
                    <!-- get stage for this job if job id is zero then show all -->
                    <?php $stages = erp_rec_get_all_stages();
                                        foreach ( $stages as $stage ) : ?>
                    <div class="filter-box-wrapper">
                      <a class="filter-box<?php if ($filter_stage == $stage['id']) echo " active-filter-box "; ?>" href="<?php echo admin_url('edit.php?post_type=erp_hr_recruitment&page=jobseeker_list&filter_stage='.$stage['id']);?>">
                    ...
                    <?php $stages = erp_rec_get_this_job_stages($jobid);
                                        foreach ( $stages as $stage ) : ?>
                    <div class="filter-box-wrapper">
                      <a class="filter-box<?php if ($filter_stage == $stage['id']) echo " active-filter-box "; ?>" href="<?php echo admin_url('edit.php?post_type=erp_hr_recruitment&page=jobseeker_list&jobid='.$jobid.'&filter_stage='.$stage['stageid']);?>">
                                                    <span class="top-zone-number">
