<div class="wrap erp-calendar-detail">
    <h1><?php _e('Add candidate','wp-erp-rec');?><span class="spinner"></span></h1>
            ...
            <div class="inside" style="overflow-y:hidden;">
                <div id="primary" class="content-area">
                    <main id="main" class="site-main" role="main">
                        ...
                        <?php $all_jobs = erp_rec_get_all_jobs();?>
                        ...
                        ?>
                        <input type="hidden" id="hidden-base-url" value="<?php echo admin_url('edit.php?post_type=erp_hr_recruitment&page=add_candidate');?>">
                        <a id="job-link" class="button button-default" href="<?php echo $actual_link;?>">
                            <?php _e('Show form','wp-erp-rec');?>
                        </a>
                        <hr/>
                            ...
                            <div id="job_seeker_apply_form_wrapper">
                                ...
                                <div id="job_seeker_table_wrapper">
                                    <form id="jobseeker_form" method="post" enctype="multipart/form-data">
                                        <h4 class="title"><?php _e('Basic information', 'wp-erp-rec'); ?></h4>
                                        <?php foreach ($default_fields as $key => $value) : ?>
                                            ...
                                            <?php elseif ( $value['type'] == 'file' ) : ?>
                                                <div class="row">
                                                    ...
                                                    <input type="button" class="file_upload button button-default inputclass <?php echo ($value['required'] == true) ? "reqc" : ""; ?>" name="<?php echo $value['name']; ?>" value="Select File"/>
                                                </div>
                                        ...
                                        <?php if ( is_array($personal_field_data) ) : ?>
                                            ...
                                            <h4 class="title"><?php _e('Addtional information', 'wp-erp-rec'); ?></h4>
                                            <?php endif;?>
