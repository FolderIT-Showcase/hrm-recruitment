  ...
  <div id="dashboard-widgets-wrap" class="">
    ...
    <div class="panel panel-default">
      ...
      <div class="tab-content panel-body">
        <div id="tab-personal-information" class="tab-pane fade in active">
          <div class="row">
        ...
        <div id="tab-ratings" class="tab-pane fade">
          <div class="row">
            <div class="col-lg-6 col-xs-12">
              <div class="single-information-container meta-box-sortables ui-sortable" style="margin-left:0px;">
        ...
        <div id="tab-evaluation-summary" class="tab-pane fade">
          <div class="row">
        ...
        <div id="tab-interviews" class="tab-pane fade">
          <div class="row">
            <div class="col-lg-12 single-information-container meta-box-sortables ui-sortable" style="margin-left:0px;">
        ...
        <div id="tab-resumes" class="tab-pane fade">
          <div class="row">
            <div class="col-lg-12 single-information-container meta-box-sortables ui-sortable" style="margin-left:0px;">
